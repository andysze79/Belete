Shader "Lux/Human/Skin" {
	...
	SubShader {
		...
		//float2 _Lux_Skin_DistanceRange; // defined in the lighting function
		...
		void surf (Input IN, inout SurfaceOutputLuxSkinSpecular o) {
			...
			//	Get the scale of the derivatives of the blurred world normal and the world position.
				// Actually ddx_fine does not improve shading and makes it rather difficult to get the shader being compiled...
